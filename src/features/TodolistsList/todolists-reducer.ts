...
export const fetchTodolistsTC = () => {
    return (dispatch: ThunkDispatch) => {
        ...
        todolistsAPI.getTodolists()
            ...
            .then((todos) => {            //наполняем тудулисты тасками
                todos.forEach((tl) => {
                    dispatch(fetchTasksTC(tl.id) as any);
                });
            })
    }
}
...
type ThunkDispatch = Dispatch<ActionsType | SetAppStatusActionType | TasksActionsType >;
